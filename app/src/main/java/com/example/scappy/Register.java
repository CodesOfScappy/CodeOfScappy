...
public class Register extends AppCompatActivity {
    ...
    DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReferenceFromUrl("https://scappy-b8483-default-rtdb.firebaseio.com/");
        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View v) {
                ...
                if(nameTxt.isEmpty() || mobileTxt.isEmpty() || emailTxt.isEmpty()){
                    Toast.makeText( Register.this, "Alle Felder benötigt!!!", Toast.LENGTH_SHORT).show();
                    ...
                    databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if(snapshot.child("user").hasChild(mobileTxt)){
                                Toast.makeText(Register.this, "Handynummer bereits Registriert", Toast.LENGTH_SHORT).show();
                            }
                            else{
                                ...
                                Toast.makeText(Register.this, "Erfolgreich", Toast.LENGTH_SHORT).show();
